...
\begin{enumerate}[(a)]
    ...
    \item Wir wollen herausfinden, welche Vorgesetzten den gr"o{\ss}ten Einfluss haben. Ein Vorgesetzter hat Einfluss auf die ihm/ihr direkt zugeordneten Mitarbeiter, aber auch auf die Mitarbeiter, die an Projekten arbeiten, die von ihm/ihr koordiniert werden. Wie kann man diesen Einfluss mittels Relationenkomposition modellieren? Stellen Sie die entsprechende Relation als Graphen dar, geben Sie das Hasse-Diagramm an, sofern es sich um eine Ordnung handelt, und interpretieren Sie das Ergebnis.
\end{enumerate}
